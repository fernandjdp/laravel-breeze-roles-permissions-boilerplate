            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                    <div class="p-6 bg-white border-b border-gray-200">
                        Permissions <span v-if="$attrs.method=='create'">create</span><span v-else>edit</span>
                    </div>
                </div>
    ...
    methods: {
        submit() {
            if (this.$attrs.method=='create') {
                this.form.post(route('permissions.store'), {forceFormData: true})
            } else {
                this.form.put(route('permissions.update', this.$attrs.permission))
            }
        },
        goBack() {
        ...
        loadFormInfo() {
            if (this.$attrs.permission) {
                ...
                this.form.name = this.$attrs.permission.name
                this.form.guard_name = this.$attrs.permission.guard_name
            }
        }
    },
};
